...
export class AppComponent {
  ...
  strBuilder(): string {
    ...
    this.qrdata && f.push(`[qrdata]="'${this.qrdata}'"`)
    ...
    this.cssClass && f.push(`[cssClass]="'${this.cssClass}'"`)
    this.colorDark && f.push(`[colorDark]="'${this.colorDark}'"`)
    this.colorLight && f.push(`[colorLight]="'${this.colorLight}'"`)

    f.push(`[elementType]="'${this.elementType}'"`)
    f.push(`[errorCorrectionLevel]="'${this.errorCorrectionLevel}'"`)
    this.margin && f.push(`[margin]="'${this.margin}'"`)
    this.scale && f.push(`[scale]="'${this.scale}'"`)
    this.title && f.push(`[title]="'${this.title}'"`)
